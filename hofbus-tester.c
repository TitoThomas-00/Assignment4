...
/*
*This creates a buncg of threads to simulate arriving buss and students.
*/
...
main()
{
  ...
  //The pervious alarm is cancelled if station_load_bus can return right away
  myalarm(0,NULL);
  ...
  for (i = 0; i < total_students; i++){
	...
	if (ret != 0 ){
 		//If this fails perhapswe exceeded some systeem limit.
		//Try refucing 'total_students'.
 ...
 while (students_left > 0){
	...
	exit(1);
            ...
            printf("Bus departed station with %d new students(s) (expected %d)\n",
	...
	return 0;
 	...
 	// I don't tjoml is reachable, but just in case.
